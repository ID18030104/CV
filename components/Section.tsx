...
const Section: React.FC<SectionProps> = ({ id, title, children, icon, className = "" }) => {
  return (
    <section id={id} className={`py-12 md:py-16 scroll-mt-20 print:break-inside-avoid ${className}`}>
      <div className="flex items-center gap-3 mb-8 md:mb-10 border-b border-slate-100 pb-4">
